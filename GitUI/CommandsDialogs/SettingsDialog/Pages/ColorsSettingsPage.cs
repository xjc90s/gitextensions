...
namespace GitUI.CommandsDialogs.SettingsDialog.Pages
{
    public partial class ColorsSettingsPage : SettingsPageWithHeader
    {
        ...
        protected override void OnRuntimeLoad()
        {
            ...
            ThemeModule.Editor.ThemeChanged += Theme_Changed;
        }
        ...
        protected override void SettingsToPage()
        {
            ...
            try
            {
                UpdateComboBoxTheme(AppSettings.UITheme);
            }
            finally
            {
                _syncingTheme = false;
        ...
        protected override void PageToSettings()
        {
            ...
            AppSettings.UITheme = (string)_NO_TRANSLATE_cbSelectTheme.SelectedItem;
        ...
        {
            ThemeModule.Editor.ResetAllColors();
        ...
        private void ComboBoxTheme_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ThemeModule.Editor.LoadSavedTheme((string)menu.SelectedItem);
            }
            finally
            {
                _syncingTheme = false;
        ...
        private void UpdateComboBoxTheme(string themeName)
        {
            ...
            _NO_TRANSLATE_cbSelectTheme.Items.AddRange(
                ThemeModule.Editor.GetSavedThemeNames().Cast<object>().ToArray());
